...
{
    [Rotation("Cooldown Debug Rotation", CombatType.PvE, GameVersion = "6.58")]
    [Api(1)]
    public class CooldownDebug : MachinistRotation
    {
        ...
        {
            act = null;
            if (GaussRoundPvE.CanUse(out act, skipClippingCheck: true))
            {
                return true;
            }
            return false;
